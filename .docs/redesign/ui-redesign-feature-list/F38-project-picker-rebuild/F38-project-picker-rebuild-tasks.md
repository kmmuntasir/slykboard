...
> **Owner sign-off (resolved 2026-06-26 — "fix as you see fit"):**
> - **D1 → client-side hash→hue from `project.slug`** (no migration; deterministic; one-line swap if a `projects.color` field ships later). Drop-dot and schema-migration alternatives rejected. No further sign-off blocking F38.
